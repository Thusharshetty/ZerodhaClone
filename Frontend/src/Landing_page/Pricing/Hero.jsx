function Hero() {
    return ( 
        <div className="container">
            ...
            <h1 className="mt-5 p-3 fs-3">Charges</h1>
            ...
            <div className="row text-center p-5 mt-5">
                ...
                <div className="col p-5">
                   <img src="media/images/intradayTrades.svg" alt="" />
                    ...
                    <p className="text-muted">Flat ₹ 20 or 0.03% (whichever is lower) per executed order on intraday trades across equity, currency, and commodity trades. 
