        ...
        <div className="container p-5">
            <div className="row p-5">
                <div className="col-6 p-5">
                    ...
                    <p className="text-muted mb-3">That's why 1.3+ crore customers trust Zerodha with ₹3.5+ lakh crores worth of equity investments.</p>
                    ...
                    <p className="text-muted mb-3">With initiatives like Nudge and Kill Switch, we don't just facilitate transactions, but actively help you do better with your money.</p>
                </div>
                <div className="col-6 p-5">
