    ...
    return (
        <div className="container">
            <div className="row p-5">
                <h1 className="fs-3 text-center p-5 fw-normal">We pioneered the discount broking model in India. <br />
            ...
            <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.8",fontSize:"1.2em"}}>
                ...
                <div className="col p-5">
                    ...
                    <p>
                        ...
                        Catch up on the latest updates on our blog or see what the media is saying about us or learn more about our business and 
