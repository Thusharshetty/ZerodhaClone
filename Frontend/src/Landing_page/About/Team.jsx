function Team() {
    return ( <div className="container">
            ...
            <div className="row px-5 pb-5 text-muted" style={{lineHeight:"1.8",fontSize:"1.2em"}}>
                <div className="col px-5 text-center">
                    <img src="media/images/nithinKamath.jpg" alt="founder"  className="rounded-circle" style={{width:"50%"}}/>
                    <h4 className="mt-5">Nithin Kamath</h4>
                    <h6>Founder & CEO</h6>
                </div>
                <div className="col px-5 fs-5">
                    <p>
